...
var $author$project$Main$Post = F6(
	function (id, title, relation, author, body, date) {
		return {author: author, body: body, date: date, id: id, relation: relation, title: title};
	});
...
var $author$project$Main$httpCommand = $elm$http$Http$get(
	{
		expect: A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(post.relation)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
...
var $author$project$Main$viewPosts = function (posts) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$viewPostsOrError = function (model) {
	var _v0 = model.errorMessage;
	if (_v0.$ === 'Just') {
		var message = _v0.a;
		return $author$project$Main$viewError(message);
	} else {
		return $author$project$Main$viewPosts(model.posts);
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewPostsOrError(model)
			]));
};
